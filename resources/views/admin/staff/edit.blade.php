        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	...
                	<div class="add">
                        <a class="btn btn-md btn-primary shadow" href="{{ Route('staff.index') }}">Back To All Staff</a>
                    </div>
					<br>
					<br>
					<!--Student button End-->	
						...
						<div class="col-xl-6 d-flex">
							<div class="card flex-fill">
							 ...
							 @if ($errors -> any())
								...
								<div class="card-body">
									<form action="{{ Route('student.update', $staff_edit -> id) }}" method="POST" enctype="multipart/form-data">
										@csrf
									<input type="hidden" name="cid" value="{{ $staff_edit -> id }}">
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Name</label>
											<div class="col-lg-9">
												<input name="name" type="text" value="{{ $staff_edit-> name }}" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Email</label>
											<div class="col-lg-9">
												<input name="email" type="text" value="{{ $staff_edit -> email}}" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Cell</label>
											<div class="col-lg-9">
												<input name="cell" type="text" value="{{ $staff_edit -> cell }}" class="form-control">
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input name="photo" type="file" value="{{ url('photos/', $staff_edit -> photo ) }}" class="form-control">
											</div>
										</div>
