					...
					<div class="row">
						<div class="col-xl-6 d-flex">
							<div class="card flex-fill">
								...
								<div class="card-body">
									<form action="{{ Route('student.update', $student_update -> id) }}" method="POST" enctype="multipart/form-data">
										@csrf
										<input type="hidden" name="cid" value="{{ $student_update -> id }}">
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Name</label>
											<div class="col-lg-9">
												<input name="name" type="text" value="{{ $student_update-> name }}" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Email</label>
											<div class="col-lg-9">
												<input name="email" type="text" value="{{ $student_update -> email}}" class="form-control">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Cell</label>
											<div class="col-lg-9">
												<input name="cell" type="text" value="{{ $student_update -> cell }}" class="form-control">
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input name="photo" type="file" value="{{ url('photos/', $student_update -> photo ) }}" class="form-control">
											</div>
										</div>
